...
NOT a data-structure member). It profiles all seventeen members against the JS built-in
...
scaling, and D8 workload micro-benches -- **seventeen members x 8 dimensions = 136 cells**.
...
The "< 40% of all" claim holds for all seventeen; with seventeen members the all-member bundle
...
**0 major GC across all seventeen.** The torture + perf gates are the authoritative
zero-alloc proof and hold **0 B/op** per steady-state op for all seventeen members (incl.
