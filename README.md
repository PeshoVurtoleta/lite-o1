...
NOT a data-structure member). It profiles all eighteen members against the JS built-in
...
scaling, and D8 workload micro-benches -- **eighteen members x 8 dimensions = 144 cells**.
...
The "< 40% of all" claim holds for all eighteen; with eighteen members the all-member bundle
...
zero-alloc proof and hold **0 B/op** per steady-state op for all eighteen members (incl.
