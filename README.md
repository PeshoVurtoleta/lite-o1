...
| ---------- | --------- | -------------------------------------------------- |
| `VERSION`  | `'1.0.0'` | Package version string.                            |
...
**478 deterministic `node:test` cases**, plus a torture gate, a hard perf gate, and the O(1) witness gate.

```bash
npm test           # 478 node:test cases (contract + boundary + differential fuzz)
