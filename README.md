...
NOT a data-structure member). It profiles all twenty members against the JS built-in
...
scaling, and D8 workload micro-benches -- **twenty members x 8 dimensions = 160 cells**.
...
The "< 40% of all" claim holds for all nineteen; with twenty members the all-member bundle
...
**0 major GC across all twenty.** The torture + perf gates are the authoritative
zero-alloc proof and hold **0 B/op** per steady-state op for all twenty members (incl.
